...
$TCA['tx_grbsweep_domain_model_textarea'] = array(
	'ctrl' => $TCA['tx_grbsweep_domain_model_textarea']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_grbsweep_domain_model_textarea.pid=###CURRENT_PID### AND tx_grbsweep_domain_model_textarea.sys_language_uid IN (-1,0)',
			),
		),
		...
		'answer' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:grb_sweep/Resources/Private/Language/locallang_db.xml:tx_grbsweep_domain_model_textarea.answer',
			'config' => array(
				'type' => 'text',
				'cols' => 40,
				'rows' => 15,
