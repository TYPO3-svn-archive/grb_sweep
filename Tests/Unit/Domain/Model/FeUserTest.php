...
/**
 * Test case for class Tx_GrbSweep_Domain_Model_FeUser.
 *
 * @version $Id$
 ...
 */
class Tx_GrbSweep_Domain_Model_FeUserTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new Tx_GrbSweep_Domain_Model_FeUser();
	}
