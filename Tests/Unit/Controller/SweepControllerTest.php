...
/**
 * Test case for class Tx_Grb_sweep_Controller_SweepController.
 *
 * @version $Id$
 ...
 */
class Tx_Grb_sweep_Controller_SweepControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
